...
export const WhatsAppButton: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Main Button */}
      <div className="relative bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#20bd5a] transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 flex items-center justify-center">
         {/* WhatsApp SVG Icon */}
      ...
      <div className="absolute right-full mr-4 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0 pointer-events-none">
        <div className="bg-white text-gc-text px-4 py-2 rounded-xl shadow-lg border border-gray-100 whitespace-nowrap relative">
