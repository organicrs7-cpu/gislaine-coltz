        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <div className="space-y-6 text-brand-surface/80 leading-relaxed text-lg font-light">
              <p>
                Especialista em protocolos de massoterapia com certificação internacional. Criou um método exclusivo que une técnicas de massagem relaxante, pedras quentes e o ritual Thai Spa em uma experiência completa e transformadora.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-10">
                ...
                >
                  <h4 className="font-bold text-xl mb-2 text-brand-soft">Método Validado</h4>
                  <p className="text-sm">Protocolo testado em centenas de atendimentos com alto índice de fidelização.</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, scale: 0.9 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  ...
                  className="bg-white/5 p-6 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors"
                >
                  <h4 className="font-bold text-xl mb-2 text-brand-soft">Experiência Real</h4>
                  <p className="text-sm">Ensina o que realmente aplica no dia a dia com suas próprias clientes.</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
