                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-stretch">
                        ...
                        >
                            ...
                            <div>
                                <h2 className="text-3xl font-bold mb-2">Protocolo Detox</h2>
                                <p className="text-brand-soft text-sm uppercase tracking-wider mb-8">Com Manta Térmica</p>

                                <div className="space-y-5">
                                    <h3 className="text-lg font-semibold border-b border-white/20 pb-2 mb-4">O que está incluso:</h3>
                                    {[
                                        "Aulas Práticas Gravadas (Passo a Passo)",
                                        "E-book de Apoio Completo (PDF)",
                        ...
                        >
                            ...
                            <div className="text-center mb-8">
                                <p className="text-gray-400 line-through mb-1">De R$ 197,00</p>
                                <div className="flex items-center justify-center text-brand-dark gap-2">
                                    <span className="text-3xl font-medium">12x de</span>
                                    <span className="text-6xl font-bold tracking-tighter">7,79</span>
                                </div>
                                <p className="text-gray-500 mt-2">ou R$ 67,00 à vista</p>
                            </div>

                            <a href="https://pay.cakto.com.br/g6hhtv9_680339" target="_blank" rel="noopener noreferrer" className="w-full">
                            ...
                            <div className="mt-6 flex flex-col items-center gap-3">
                                ...
                                <div className="flex gap-3 grayscale opacity-50">
                                    ...
                                    {/* Add more payment icons representation if needed */}
                                </div>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    >
                        Uma única aplicação deste protocolo em uma cliente já paga o seu investimento. O restante é <strong className="text-brand-primary">LUCRO PURO</strong> no seu bolso.
                    </motion.p>
                </div>
            </div>
        </section>
